      ...
      <div className="w-[90%] max-w-[1200px] flex lg:flex-row flex-col gap-8 h-[600px]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-5 min-h-0">
          <div className="flex-1 overflow-y-auto pr-3 hide-scrollbar">
            {smallBlogs.map((blog) => (
              <article key={blog._id} className="flex border border-[#E2DFDF] rounded-[14px] overflow-hidden bg-white mb-4">
                <img src={blog.image} alt={blog.title} className="w-[179px] h-[175px] object-cover flex-shrink-0" />
